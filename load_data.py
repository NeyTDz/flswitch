...
def sep_dataset(client_idx,train_file):
    ...
    When CLIENT_NUM = 10,20: just average
    When CLIENT_NUM = 50,100: fix & random
    '''
    ...
    #print(len(part_train_file))
    #print(len(part_train_file) / BATCH_SIZE)
    return part_train_file
 
def mk_dirs():
    for path in [ACC_RECORDS_PATH,CHOICE_PATH,PRE_RECORDS_PATH,PRE_PARAMS_PATH]:
